...
interface NewsItem {
  ...
  summary: string;
  content: string;
  category: "all" | "notice" | "feature" | "tips" | "community" | "security";
...
export default function NewsPage() {
  ...
  // Pinned Hero Feature Story
  const heroStory: NewsItem = {
    id: 1,
    ...
    author: "Shabos Rent Editorial Team",
  ...
  const editorsPicks: NewsItem[] = [
    {
      ...
      content: "Ahead of the upcoming busy High Holidays and Shabbat seasons, Shabos Rent is proud to launch our upgraded verification protocol.",
      category: "notice",
      categoryLabel: "OFFICIAL NOTICE",
      date: "May 1, 2026",
      readTime: "5 min read",
    ...
    },
    {
      ...
      content: "To make our platform accessible to everyone in the community, we have officially rolled out the Shabos Rent Voice Hotline.",
      category: "feature",
      categoryLabel: "GUIDE",
      date: "Apr 30, 2026",
      readTime: "4 min read",
    ...
    },
    {
      ...
      summary: "Practical tips on cleaning, setup, and creating a warm, inviting space.",
      content: "Successful Shabbat hosting is all in the details. Shabbat renters deeply appreciate a backup mechanical key and clear instructions.",
      category: "tips",
  ...
  // Latest Articles & Updates Grid (2x2 Horizontal Cards)
  const latestArticles: NewsItem[] = [
    {
      id: 4,
      ...
      content: "We are thrilled to announce major expansion in central Israel and greater Jerusalem regions.",
      category: "community",
    ...
    },
    {
      ...
      content: "Community trust is our highest priority. Moving forward, all platform members undergo phone verification and identity checks.",
      category: "security",
    ...
    },
    {
      ...
      content: "The Shabos Rent Swap feature celebrates a major milestone. Families visiting relatives in Jerusalem swap homes completely rent-free!",
      category: "community",
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-zinc-950 font-sans flex flex-col justify-between selection:bg-[#1b365d]/20 selection:text-[#1b365d]">
      <div>
        ...
        {/* Hero Section (2-Column Banner Matching Screenshot Exactly) */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-6 flex flex-col justify-between">
                ...
                <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-4 border-t border-zinc-200/60 dark:border-zinc-800">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="text-xs font-extrabold text-zinc-900 dark:text-white leading-none">50+</div>
              ...
              <div className="lg:col-span-6 flex">
                ...
                >
                  ...
                  />
                  {/* Refined Gradient Overlay for Clear Visibility */}
                  ...
                  <div className="relative z-10 space-y-4">
                    ...
                    <div className="pt-4 flex items-center justify-between border-t border-white/15">
                      ...
                      <button className="flex items-center gap-1.5 text-xs font-bold text-white group-hover:translate-x-1 transition-transform">
        ...
        {/* Filter Navigation Bar matching Reference Screenshot */}
        <section className="border-b border-zinc-200/80 dark:border-zinc-800 bg-white dark:bg-zinc-950 py-3">
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="flex items-center justify-between gap-4 overflow-x-auto hide-scrollbar">
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-bold text-zinc-600 dark:text-zinc-400 hover:text-[#0f172a] transition-colors shrink-0"
              >
        ...
        <main className="container mx-auto px-4 max-w-7xl py-12 md:py-16 space-y-16">
          ...
          {/* Section 1: Editor's Picks (3 Big Cards Row) */}
          <section>
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs text-zinc-500 font-medium hidden sm:inline-block">
                The most important stories, chosen for you.
              </span>
            </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs text-zinc-500 font-medium hidden sm:inline-block">
                Stay informed with our latest news and stories.
              </span>
            </div>
          ...
          {/* Section 3: Stay in the Loop (Newsletter Box matching Screenshot) */}
          ...
          >
            ...
            >
              ...
              <div className="prose dark:prose-invert max-w-none text-zinc-700 dark:text-zinc-300 text-xs sm:text-sm leading-relaxed space-y-4">
                ...
                <p>
                  {isHebrew 
                    ? "למידע נוסף ולשאלות לגבי הזמנת דירות שבת, ניתן ליצור קשר עם צוות התמיכה או לחייג לקו החם הקולי."
                    : "For further inquiries or assistance regarding Shabbat apartment bookings, please contact our support team or dial our dedicated voice hotline."}
                </p>
              </div>
              ...
              <div className="mt-8 pt-5 border-t border-zinc-100 dark:border-zinc-800 flex justify-end">
                <button
                  onClick={() => setSelectedNews(null)}
                  className="px-5 py-2 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 text-xs font-extrabold rounded-xl hover:opacity-90 transition-opacity"
                >
                  Close Article
                </button>
              </div>
