...
export default function AddApartmentModal({ isOpen, onClose }: AddApartmentModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-zinc-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden border border-zinc-200 dark:border-zinc-800 animate-in zoom-in-95 duration-300 relative">
            ...
            {!isLoggedIn ? (
              <div className="space-y-3">
                ...
                <p className="text-center text-xs text-zinc-500">
                  You need to be signed in to add an apartment.
                </p>
              </div>
            ) : (
              <Link 
