...
export default function PopularCities() {
  const cities = [
    { name: "Jerusalem", count: 1245, image: "https://images.unsplash.com/photo-1572120360610-d971b9d7767c?q=80&w=800&auto=format&fit=crop" },
    { name: "Bnei Brak", count: 823, image: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?q=80&w=800&auto=format&fit=crop" },
    { name: "Tzfat", count: 312, image: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?q=80&w=800&auto=format&fit=crop" },
    { name: "Beit Shemesh", count: 276, image: "https://images.unsplash.com/photo-1555854877-bab0e564b8d5?q=80&w=800&auto=format&fit=crop" },
    { name: "Modiin Illit", count: 198, image: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?q=80&w=800&auto=format&fit=crop" },
  ];
  ...
  return (
    <section className="container mx-auto px-4 pb-20 font-sans">
      <div className="relative mb-8 text-center flex flex-col items-center justify-center min-h-[60px]">
        <h2 className="text-[32px] font-extrabold text-[#0B1536] dark:text-white mb-1 tracking-tight">Popular Cities</h2>
        <p className="text-sm text-zinc-500 dark:text-zinc-400 font-medium">Explore apartments in the most searched cities</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-5">
        {cities.map((city, idx) => (
          <Link key={idx} href={`/search?city=${city.name.toLowerCase().replace(" ", "-")}`} className="group relative h-[240px] rounded-[20px] overflow-hidden block bg-transparent p-[3px]">
            ...
            <div className="relative w-full h-full rounded-[17px] overflow-hidden z-10 bg-zinc-100 dark:bg-zinc-900">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 flex items-end justify-between">
                <div>
                  ...
                  <p className="text-white/80 text-[13px] font-medium">{city.count.toLocaleString()} Apartments</p>
                </div>
